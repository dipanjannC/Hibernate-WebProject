			...
			<div class="col-md-8">
				...
				<div>
					...
					<form action="StoreServlet" method="get">
						<h2>Update Stock</h2>
						<hr>
						ProdutID: <input type="number" name="addInventoryProductId"
							value="<%=request.getAttribute("productID")%>" readonly />
						<hr>
						Stock: <input type="number" name="addInventoryStock"
							placeholder="<%=request.getAttribute("inventoryStock")%>" />
						<hr>
						Buffer: <input type="number" name="addInventoryBuffer"
							value="<%=request.getAttribute("inventoryBuffer")%>" readonly />
						<hr>
						<div align="right">
							<input type="submit" name="update" value="Update"
								class="btn btn-content" /> <input type="reset"
								class="btn btn-content" value="Cancel">
						</div>
					</form>
